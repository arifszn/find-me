        ...
        <React.Fragment>
            <div className="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row items-center">
                <div className="sm:w-2/5 flex flex-col items-start mt-8 sm:mt-0 mb-5 sm:mb-0">
                    <h1 className="text-4xl lg:text-6xl leading-none mb-4 mx-auto md:ml-0"><strong className="font-black">Face</strong> Finder</h1>
                    <p className="lg:text-lg mb-4 sm:mb-12 text-center md:text-left">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam. Lorem ipsum dolor sit amet.</p>
                    <a 
                        href={'/#'}
                        onClick={(e) => {
                            e.preventDefault();
